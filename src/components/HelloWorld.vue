<template>
  <div class="box">
    <div class="top">
      <div class="flex flex-space">
        ...
        <div class="date m-l-10">
          ...
          <span class="v-shape-top" @click="visible = true"></span>
        </div>
        <div class="v-shape-right m-l-10" @click="changeDate('add')"></div>
      </div>
    </div>
    <div class="select-time" v-if="visible">
      <div class="year">
        <div
          class="item"
    ...
    <div class="two">
      ...
      <div v-for="num in [1, 2, 3, 4, 5, 6]" :key="num" class="m-t-10">
        <div class="flex">
          <div
        ...
        if (num === 0) {
          if (this.select.getMonth() === 0) {
           ...
           return  getLunar(this.select.getFullYear() - 1, 12, r.value)
            ...
            console.log(this.select.getFullYear(), this.select.getMonth(), r.value,'this.select.getFullYear(), this.select.getMonth(), r.value')
