...
export const routes = [
  ...
  {
    path: '/flower', component: defineAsyncComponent(() => import('../components/markdown/vue/flower.vue')) 
  },
  {
    path: '/exericise', component: defineAsyncComponent(() => import('../components/exericiseField')) ,
  },
  { path: '/exericise/vue', component: defineAsyncComponent(() => import('../components/exericiseField/vueRepl.vue'))  },
  { path: '/exericise/html', component: defineAsyncComponent(() => import('../components/exericiseField/html.vue'))  },
  {
    path: '/logs', component: defineAsyncComponent(() => import('../components/personalLogs')) ,
  },
  {
    path: '/logs/see', component: defineAsyncComponent(() => import('../components/personalLogs/see')) ,
  },
  {
    path: '/resume', component: defineAsyncComponent(() => import('../components/personalResume')) ,
  },

  {
    path: '/cutout', component: defineAsyncComponent(() => import('../components/cutout')) ,
  },
